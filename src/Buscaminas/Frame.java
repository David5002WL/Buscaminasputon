package Buscaminas;
	//Debe de salir un tablero para poder jugar al Buscaminas
...
private void metodoStackOverFlow(int i, int z) {
    if ( z!=0 && i!=0 && z!=alto-1 && i!=ancho-1){
    Botones[i-1][z].setEnabled(true);
    Botones[i-1][z-1].setEnabled(true);
    Botones[i-1][z+1].setEnabled(true);
    Botones[i][z-1].setEnabled(true);
    Botones[i][z+1].setEnabled(true);
    Botones[i+1][z].setEnabled(true);
    Botones[i+1][z+1].setEnabled(true);
    Botones[i+1][z-1].setEnabled(true);
